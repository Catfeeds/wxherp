...
INSERT INTO `t_system_route` VALUES ('264', '活动用户列表', '/event/user/index', '', '26', '5', '1', '1443409950', '2017-04-14 15:49:13');
...
-- ----------------------------
DROP TABLE IF EXISTS `t_common_keyword`;
CREATE TABLE `t_common_keyword` (
  ...
  `c_count` int(10) unsigned NOT NULL DEFAULT '1' COMMENT '搜索数量',
  `c_sort` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '关键词排序',
  `c_create_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `c_update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间',
  PRIMARY KEY (`c_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='关键词搜索记录表';

-- ----------------------------
-- Records of t_common_keyword
-- ----------------------------
