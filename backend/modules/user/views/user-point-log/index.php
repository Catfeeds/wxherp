...
$pagesize = isset($get['UserPointLogSearch']['pagesize']) ? $get['UserPointLogSearch']['pagesize'] : '';
$keyword = isset($get['UserPointLogSearch']['keyword']) ? trim($get['UserPointLogSearch']['keyword']) : '';
...
<div class="box box-primary">
    <div class="box-header">
        <div class="pull-left">
            ...
            <?= $form->field($searchModel, 'pagesize')->dropDownList(UserPointLog::getPageSize(), ['prompt' => '选择页码', 'value' => $pagesize]) ?>
    ...
    <div class="box-body">
        ...
        GridView::widget([
            ...
            'columns' => [
                ...
                'c_point_old', 'c_point', 'c_point_new', 'c_exp_old', 'c_exp', 'c_exp_new', 'c_system_name',
                [
                    'attribute' => 'c_note_type',
                    'format' => 'raw',
                    'value' => function($model) {
                        return UserPointLog::getNote($model->c_note_type) . ($model->c_order_no ? '<br>订单号：' . $model->c_order_no : '');
                    },
                ],
                [
